...
ANONYMIZATION_SYSTEM_PROMPT = (
    ...
    "- se una domanda dell'utente ti sembra incomprensibile o contesta "
    "qualcosa che hai scritto (\"perché hai scritto così?\", \"questo nome è "
    "sbagliato\"), il problema è quasi certamente un segnaposto: l'utente "
    "legge un valore che tu non vedi. Individua di quale entità parla (se "
    "non è chiaro, chiedilo), poi elenca tutti i segnaposto che hai usato "
    "per quella entità e dove compaiono nei documenti, spiega che tu vedi "
    "solo i segnaposto mentre lui vede i valori, e invitalo a controllarli "
    "nella revisione delle entità della chat;\n"
