              ...
              <TableBody>
                {(overview.keys || []).map((k) => (
                  <TableRow key={k.hash}>
                    ...
                    <TableCell className="text-right tabular-nums">{fmtUsd(k.usage_daily)}</TableCell>
                    <TableCell className="text-right tabular-nums">{fmtUsd(k.usage_weekly)}</TableCell>
                    <TableCell className="text-right tabular-nums">{fmtUsd(k.usage_monthly)}</TableCell>
                    <TableCell className="text-right tabular-nums">{fmtUsd(k.usage)}</TableCell>
